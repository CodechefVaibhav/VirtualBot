...
public class ChildRummyBot extends RummyBot {
	...
	protected RummyBotIntelligence rummyAI=new RummyBotIntelligence(this);
	//String userName = null;
	//String password = null;
	//String roomName = null;
	String botRank = null;
	String chipType = null;
	int opponentSeatId = -1;
	ChildClientKeepAlive clientKeepAlive = null;
	boolean myNextPlayerturn = false;
	...
	public void onExtension(SFSEvent evt)
	{
		...
		else if (params.get("cmd").equals("game.started")) // not needed really
		{
			...
			turnCount = 0;
			rummyAI.updateNumberOfMyTurnsHavePassed(turnCount);
			rummyAI.saveOpponentPlayersPickedCards(0,null,true);
			if(takenSeat)
			{
				gameStarted=true;
			}
